...
ast = parse_file(filename="examples/c_files/TODO/MP-rounds-continue-nocom.c", use_cpp=False)
...
take_code_from_file(ast, "examples/c_files/TODO/MP-rounds-continue-nocom.c", config.variables_1['round'],
