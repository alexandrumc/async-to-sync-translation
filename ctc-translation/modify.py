...
ast = parse_file(filename="examples/c_files/verified_copy/Paxos-like-leaderElection-with-AUX_ROUND.c", use_cpp=False)
...
take_code_from_file(ast, "examples/c_files/verified_copy/Paxos-like-leaderElection-with-AUX_ROUND.c", config.variables_1['round'],
