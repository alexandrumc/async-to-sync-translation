...
ast = parse_file(filename="../examples/c_files/verified_copy/ct-non-terminating-with-AUX_ROUND.c", use_cpp=False)
...
take_code_from_file(ast,"../examples/c_files/verified_copy/ct-non-terminating-with-AUX_ROUND.c",'round')
#print ast
