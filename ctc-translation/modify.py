...
ast = parse_file(filename="../examples/c_files/verified/Leader-election-Zab_modified.c", use_cpp=False)
...
take_code_from_file(ast,"../examples/c_files/verified/Leader-election-Zab_modified.c",'round')
# print generator.visit(ast)
