...
ast = parse_file(filename="../examples/c_files/verified_copy/tpc_AMIT_modificat-with-AUX_ROUND.c", use_cpp=False)
...
take_code_from_file(ast, "../examples/c_files/verified_copy/tpc_AMIT_modificat-with-AUX_ROUND.c", config.variables_1['round'],
