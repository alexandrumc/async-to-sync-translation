...
ast = parse_file(filename="../examples/c_files/verified_copy/ct-non-terminating.c", use_cpp=False)
...
take_code_from_file(ast,"../examples/c_files/verified_copy/ct-non-terminating.c",'round')
#print ast
