...
ast = parse_file(filename="../examples/c_files/verified_copy/CT_terminating_v01.c", use_cpp=False)
...
take_code_from_file(ast, "../examples/c_files/verified_copy/CT_terminating_v01.c", config.variables_1['round'],
