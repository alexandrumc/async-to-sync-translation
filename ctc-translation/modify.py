...
ast = parse_file(filename="../examples/c_files/verified/paper_example-nojump-withAUX-nocomm.c", use_cpp=False)
...
take_code_from_file(ast,"../examples/c_files/verified/paper_example-nojump-withAUX-nocomm.c",'round')
# print generator.visit(ast)
