...
ast = parse_file(filename="/Users/alexandrum/ENS/pycparser/examples/c_files/verified/Leader-election-Zab_modified.c", use_cpp=False)
...
take_code_from_file(ast,"/Users/alexandrum/ENS/pycparser/examples/c_files/verified/Leader-election-Zab_modified.c",'round')
# print generator.visit(ast)
