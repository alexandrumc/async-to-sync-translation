...
ast = parse_file(filename="../examples/c_files/verified_copy/paper_example-nojump-with-AUX-ROUND_modified-with-PHASE.c", use_cpp=False)
...
take_code_from_file(ast,"../examples/c_files/verified_copy/paper_example-nojump-with-AUX-ROUND_modified-with-PHASE.c",'round')
#print ast
