...
int main(int argc, char **argv)
{
    ...
    while (true) {
        ...
        if (pid == get_primary(view_nr, n)) {
            ...
            if ((mboxB != NULL && mboxB->size >= n / 2 && mboxB->next == NULL) || (transfer_to_algo == 1)) {
                ...
                if ((mboxB != NULL && mboxB->size >= n / 2) || (transfer_to_algo == 1)) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            if (msgA != NULL && msgA->view_nr == view_nr && msgA->label == PrepareOk
                                ...
                                /* recovery_buffer is used to maintain last info
                                   from a backup process - will help late backups
                                   to recover in the same view */
            ...
            if ((mboxB != NULL && mboxB->size >= n / 2 && mboxB->next == NULL) or (transfer_to_algo == 1)) {
                ...
                if ((mboxB != NULL && mboxB->size == 1 && mboxB->next == NULL) || (transfer_to_algo == 1)) {
