...
/*@
 ...
 &*& msg->round |-> ?r &*& msg->epoch |-> _ &*& msg->i |->_ &*& msg->lab|->_ &*& msg->op|->_ &*&
...
/*@
 ...
 msg->history_lenght |-> _ &*& msg->sender |-> _ &*& msg->i |->_ &*& msg->lab|->_ &*& msg->op|->_ &*& malloc_block_Msg(msg)
 &*& malloc_block_List(n)
...
msg->history_lenght |-> _ &*& msg->sender |-> _  &*&msg->i |->_ &*& msg->lab|->_ &*& msg->op|->_ &*&
...
//@ requires msg->round |-> ?r &*& msg->epoch |-> ?v &*& msg->pid|->_ &*& msg->history|-> ?hs &*& msg->history_lenght|-> ?hslen &*& msg->sender|->_ &*& msg->op|-> _ &*& msg->i|->_ &*& msg->lab|->_ &*&  malloc_block_Msg(msg) &*& (r==New_Leader)? arraylist(hs,?hsdata) : true;
//@ ensures emp;
...
msg* recv();
//@ requires emp;
//@ ensures result->round |-> ?r &*& result->epoch |-> ?v &*& result->pid|->_ &*& result->history|-> ?hs &*& result->history_lenght|-> ?hslen &*& result->sender|->_ &*& result->op|-> _ &*& result->i|->_ &*& result->lab|->_ &*&  malloc_block_Msg(result) &*& INT_MIN <v &*& v < INT_MAX;
