...
/*@
 ...
 &*& msg->round |-> _ &*& msg->epoch |-> _ &*& 
msg->pid |-> _ &*& msg->history |-> _ &*& 
msg->history_lenght |-> _ &*& msg->sender |-> _  &*& malloc_block_Msg(msg) &*& list_pred(next);
 @*/
...
/*@
 ...
 :
 n->message |-> ?msg &*&
 msg->epoch |-> ?e &*& msg->round |-> ?r &*& msg->pid |-> _ &*& msg->history |-> _ &*& 
...
msg* recv();
//@ requires emp;
//@ ensures result->round |-> ?r &*& result->epoch |-> ?v &*& result->pid|->_ &*& result->history|->_ &*& result->history_lenght|->_ &*& result->sender|->_ &*&  malloc_block_Msg(result) &*& INT_MIN <v &*& v < INT_MAX;
...
//@requires list_pred(mbox) &*& lastIndex >=0; 
//@ensures list_pred(mbox)&*& arraylist(result,?v) &*& length(v)==lastIndex; 
